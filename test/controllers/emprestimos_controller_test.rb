...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference('Emprestimo.count') do
      post emprestimos_url, params: { emprestimo: { aluno: @emprestimo.aluno, codigo: @emprestimo.codigo, data_devoluncao: @emprestimo.data_devoluncao, data_emprestimo: @emprestimo.data_emprestimo, livro: @emprestimo.livro, matricula: @emprestimo.matricula } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { aluno: @emprestimo.aluno, codigo: @emprestimo.codigo, data_devoluncao: @emprestimo.data_devoluncao, data_emprestimo: @emprestimo.data_emprestimo, livro: @emprestimo.livro, matricula: @emprestimo.matricula } }

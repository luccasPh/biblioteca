...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { email: @aluno.email, matricula: @aluno.matricula, nome: @aluno.nome, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { email: @aluno.email, matricula: @aluno.matricula, nome: @aluno.nome, telefone: @aluno.telefone } }
